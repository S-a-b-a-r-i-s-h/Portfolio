...
const LeetCodeSVG = ({ cursor, cardRef, mouseOnCard }: Props) => {
  ...
  return (
    <div>
        ...
        viewBox="0 0 20 25"
        id="leetcode"
        className="duration-200 h-[25vh] max-sm:stroke-[#fcff2f] border-green-300 transition-all w-[25vh]"
        >
        <defs>
            <radialGradient
            id="yellowGradient"
            ...
            >
            {mouseOnCard && <stop stopColor="#fcff2f" />}
